...
import com.github.tnoalex.XLintCoreBundle
import com.github.tnoalex.specs.FormatterSpec
import io.github.xyzboom.xlint.IContext
import org.slf4j.LoggerFactory
import java.time.ZonedDateTime

class Reporter(private val formatterSpec: FormatterSpec, private val context: IContext) {
    ...
    private fun getMetaInfo(): LinkedHashMap<String, Any> {
        ...
        metaInfo["XLintVersion"] = XLintCoreBundle.message("meta.XLintVersion")
        metaInfo["XLintBuildTime"] = XLintCoreBundle.message("meta.XLintBuildTime")
